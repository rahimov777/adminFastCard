              ...
              <Card className="p-6">
                ...
                <div className="flex gap-2">
                  {color?.map((elem) => (
                    <div
                      key={elem.id}
                      className="relative  flex gap-[5px] group"
                    >
                      <button
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      <button onClick={() => dispatch(DelteColor(elem.id))} className="cursor-pointer absolute -top-2 -right-2 hidden rounded-full bg-white p-1 shadow group-hover:block">
                        <FaTrashAlt className="text-red-500 h-3 w-3" />
                      </button>
                    </div>
                  ))}
                </div>
